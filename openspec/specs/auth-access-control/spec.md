...
## Purpose
Guarantee that account privileges cannot be self-granted or retained after deactivation: clients cannot assign `role`/`isActive` at registration, and deactivated users cannot authenticate.
